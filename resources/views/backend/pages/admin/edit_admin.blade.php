            ...
            <div class="card-body">
                ...
                <form id="myForm" method="POST" action="{{route('update.admin',$user->id)}}"  class="forms-sample">
                  @csrf
                    ...
                    <div class="form-group mb-3">
                        <label for="exampleInputUsername2" class="form-label">Adress</label>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="password" name="password"   value="{{$user->password}}"class="form-control"  autocomplete="off" >  
                    </div>
                    <div class="form-group mb-3">
