            ...
            <div class="card-body">
                ...
                <form method="POST"   class="forms-sample">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="{{$profileData->user}}"class="form-control" id="exampleInputUser" autocomplete="off" placeholder="User">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"   name="phone" value="{{$profileData->phone}}"class="form-control" id="exampleInputPhone" placeholder="Phone">
                    </div>                   
                    <div class="mb-3">
                        <label for="exampleInputAddress" class="form-label">Adrress</label>
                        <input type="text"   name="address" value="{{$profileData->address}}"class="form-control" id="exampleInputAddress" placeholder="Address">
                    </div>
                    <div class="mb-3">
